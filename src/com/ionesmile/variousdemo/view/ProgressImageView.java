...
public class ProgressImageView extends ImageView {
    ...
    private void init(){
        ...
        progressColor = Color.RED; //getResources().getColor(R.color.color_main);
        shadowColor = Color.GREEN; // getResources().getColor(R.color.color_main_light);
        ...
        int color = Color.GRAY; // getResources().getColor(R.color.color_grey);
