...
public class KnobView extends ImageView {
    ...
    private void init(Context context) {
        ...
        left = getResources().getDrawable(R.drawable.img_lamp_brightness_low);
        int leftHalfWidth = left.getIntrinsicWidth() / 2;
        int leftHalfHeight = left.getIntrinsicHeight() / 2;
        left.setBounds(-leftHalfWidth, -leftHalfHeight, leftHalfWidth, leftHalfHeight);

        right = getResources().getDrawable(R.drawable.img_lamp_brightness_high);
        int rightHalfWidth = right.getIntrinsicWidth() / 2;
        int rightHalfHeight = right.getIntrinsicHeight() / 2;
        right.setBounds(-rightHalfWidth, -rightHalfHeight,rightHalfWidth, rightHalfHeight);

        thumb = getResources().getDrawable(R.drawable.ic_thumb2);
        ...
        int colorProgress = 0xFF00d1db;
        int midColor = 0xFF9ffcfe;
