...
/**
 * Created by chiemy on 15/8/5.
 */
public class BitmapBlurHelper {
    //缩放系数
    public final static int SCALE = 8;

    public static Bitmap doBlur(Context context, Bitmap bitmap, float radius, int sample){
        Bitmap scaledBitmap = Bitmap.createScaledBitmap(bitmap, bitmap.getWidth() / sample, bitmap.getHeight() / sample, false);
        return doBlur(context, scaledBitmap, radius);
    }
